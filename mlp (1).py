...
def train_test_split(df, train_percent, us, SEED):
...
def seed_loop(target_df, target_col, drop_columns, K):
  ...
  for seed in seeds:
      ...
      #outside loop?
      train_df, val_df = train_test_split(target_df, 0.6, us=False, SEED = seed)
      val_df, test_df = train_test_split(val_df, 0.5, us=False, SEED = seed)
